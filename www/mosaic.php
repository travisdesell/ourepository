...
function display_mosaic($user_id, $project_id, $mosaic_id) {
    ...
    //TODO: need to pass these as JSON
    /*
        $mosaic_info = "var tiles_url = './mosaics/" . $filename . "_files/'\n";
    $mosaic_info .= "var height = $height\n";
    $mosaic_info .= "var width = $width\n";
     */
    ...
    echo $m->render($mosaic_template, $mosaic);
}
